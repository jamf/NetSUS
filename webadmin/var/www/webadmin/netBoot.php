...
<div class="row">
	<div class="col-xs-12 col-sm-10 col-lg-8">
		...
		<form action="netBoot.php" method="post" name="NetBoot" id="NetBoot">
			...
			<input type="button" name="uploadnbi" id="uploadnbi" class="btn btn-sm btn-primary" value="Upload NetBoot Image" onClick="javascript:ajaxPost('sharingCtl.php', 'smb=enable'); window.location.assign('smb://smbuser@<?php echo trim(getCurrentIP()); ?>/NetBoot');"/>
