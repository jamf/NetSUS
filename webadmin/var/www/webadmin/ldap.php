...
if (isset($_POST['saveLDAPConfiguration']) && isset($_POST['server']) && isset($_POST['domain']) && isset($_POST['username']) && isset($_POST['password']))
{
        if ($_POST['server'] == "")
        {
        ...
        else if ($_POST['domain'] == "")
        {
                ...
                $conf->setSetting("ldapusername", $_POST['username']);
                if ($_POST['password'] != "notthepassword" && $_POST['password'] != "")
                        $conf->setSetting("ldappassword", base64_encode($_POST['password']));
...
<div id="form-wrapper">
        ...
        <form action="ldap.php" method="post" name="LDAP" id="LDAP">
                ...
                <div id="form-inside">
                        ...
                        <input type="text" name="username" id="username" value="<?php echo $conf->getSetting('ldapusername');?>" />
                        <br>

                        <span class="label">Password</span>
                        <input type="password" name="password" id="password" value="notthepassword" />
                        <br>
                        ...
                        <span class="label">Administration Group/User</span>
