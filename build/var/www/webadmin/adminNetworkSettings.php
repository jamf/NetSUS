...
<form action="admin.php" method="post" name="NetworkSettings" id="NetworkSettings"><br />
...
<table style="border: 0px;" class="formLabel">
	...
	<tr>
		...
		<td><label for="dhcp">DHCP</label><input type="radio" name="nettype" value="dhcp" id="dhcp" <?= ($type=="dhcp"?" checked=\"checked\"":"") ?> onclick="disableStaticOptions(true);" /> 
		<label for="static">Static</label><input type="radio" name="nettype" value="static" id="static" <?= ($type=="static"?" checked=\"checked\"":"") ?> onclick="disableStaticOptions(false);" /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td></td>
...
<br />
<br />
<input type="submit" value="Save Network Configuration" name="SaveNetwork"/></form>
</center>
